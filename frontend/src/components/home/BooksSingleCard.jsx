  ...
  return (
    <div
      ...
      className="border-2 border-gray-500
                rounded-lg px-4 py-2 relative hover:shadow-xl
                "
    >
      <h2
      ...
      >
        ...
        <Link to={`/books/edit/${item._id}`}>
          <AiOutlineEdit className="text-yellow-400 text-2xl hover:text-black" />
        </Link>
      ...
      {openModel && (
        <BookModel onclose={() => setOpenModel(false)} item={item} />
      )}
    </div>
  );
};
